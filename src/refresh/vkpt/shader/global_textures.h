...
#define LIST_IMAGES \
	...
	IMG_DO(DLSS_DEPTH,                39, R32_SFLOAT,          r32f,    IMG_WIDTH,           IMG_HEIGHT     ) \
	IMG_DO(PT_DLSS_MOTION,            40, R16G16B16A16_SFLOAT, rgba16f, IMG_WIDTH,           IMG_HEIGHT     ) \
	IMG_DO(PT_REFLECT_MOTION,         41, R16G16B16A16_SFLOAT, rgba16f, IMG_WIDTH,           IMG_HEIGHT     ) \
	IMG_DO(DLSS_RAY_LENGTH,           42, R16_SFLOAT,          r16f,    IMG_WIDTH,           IMG_HEIGHT     ) \
	IMG_DO(DLSS_TRANSPARENT,          43, R16G16B16A16_SFLOAT, rgba16f, IMG_WIDTH,           IMG_HEIGHT     ) \
	IMG_DO(DLSS_3DMOTION_VECTOR,      44, R16G16B16A16_SFLOAT, rgba16f, IMG_WIDTH,           IMG_HEIGHT     ) \
	IMG_DO(DLSS_REFLECT_MOTION,       45, R16G16B16A16_SFLOAT, rgba16f, IMG_WIDTH,           IMG_HEIGHT     ) \
	IMG_DO(DLSS_ALBEDO,               46, R16G16B16A16_SFLOAT, rgba16f, IMG_WIDTH,           IMG_HEIGHT     ) \
	IMG_DO(DLSS_SPECULAR,             47, R16G16B16A16_SFLOAT, rgba16f, IMG_WIDTH,           IMG_HEIGHT     ) \
	IMG_DO(DLSS_ROUGHNESS,            48, R8_UNORM,            r8,      IMG_WIDTH,           IMG_HEIGHT     ) \
	IMG_DO(DLSS_METALLIC,             49, R8_UNORM,            r8,      IMG_WIDTH,           IMG_HEIGHT     ) \
	IMG_DO(DLSS_NORMAL,               50, R16G16B16A16_SFLOAT, rgba16f, IMG_WIDTH,           IMG_HEIGHT     ) \
	IMG_DO(DLSS_MATERIALID,           51, R8_UINT,             r8ui,    IMG_WIDTH,           IMG_HEIGHT     ) \
	IMG_DO(DLSS_EMISSIVE,             52, R16G16B16A16_SFLOAT, rgba16f, IMG_WIDTH,           IMG_HEIGHT     ) \
	IMG_DO(DLSS_INDIRECT_ALBEDO,      53, R16G16B16A16_SFLOAT, rgba16f, IMG_WIDTH,           IMG_HEIGHT     ) \
	IMG_DO(DLSS_SPECULAR_ALBEDO,      54, R16G16B16A16_SFLOAT, rgba16f, IMG_WIDTH,           IMG_HEIGHT     ) \
	IMG_DO(DLSS_BEFORE_TRANSPARENT,   55, R16G16B16A16_SFLOAT, rgba16f, IMG_WIDTH,           IMG_HEIGHT     ) \
	IMG_DO(DLSS_RAYLENGTH_DIFFUSE,    56, R16_SFLOAT,          r16f,    IMG_WIDTH,           IMG_HEIGHT     ) \
	IMG_DO(DLSS_RAYLENGTH_SPECULAR,   57, R16_SFLOAT,          r16f,    IMG_WIDTH,           IMG_HEIGHT     ) \
	IMG_DO(DLSS_REFLECTED_ALBEDO,     58, R16G16B16A16_SFLOAT, rgba16f, IMG_WIDTH,           IMG_HEIGHT     ) \
	/* Ray Reconstruction source buffers - written by path tracer at render resolution */ \
	IMG_DO(PT_ALBEDO,                 59, R16G16B16A16_SFLOAT, rgba16f, IMG_WIDTH,           IMG_HEIGHT     ) \
	IMG_DO(PT_SPECULAR,               60, R16G16B16A16_SFLOAT, rgba16f, IMG_WIDTH,           IMG_HEIGHT     ) \
	IMG_DO(PT_ROUGHNESS,              61, R16G16B16A16_SFLOAT, rgba16f, IMG_WIDTH,           IMG_HEIGHT     ) \
	IMG_DO(PT_METALLIC_RR,            62, R16G16B16A16_SFLOAT, rgba16f, IMG_WIDTH,           IMG_HEIGHT     ) \
	IMG_DO(PT_NORMAL_RR,              63, R16G16B16A16_SFLOAT, rgba16f, IMG_WIDTH,           IMG_HEIGHT     ) \
	IMG_DO(PT_MATERIALID,             64, R16G16B16A16_SFLOAT, rgba16f, IMG_WIDTH,           IMG_HEIGHT     ) \
	IMG_DO(PT_EMISSIVE_RR,            65, R16G16B16A16_SFLOAT, rgba16f, IMG_WIDTH,           IMG_HEIGHT     ) \
	IMG_DO(PT_INDIRECT_ALBEDO,        66, R16G16B16A16_SFLOAT, rgba16f, IMG_WIDTH,           IMG_HEIGHT     ) \
	IMG_DO(PT_SPECULAR_ALBEDO,        67, R16G16B16A16_SFLOAT, rgba16f, IMG_WIDTH,           IMG_HEIGHT     ) \
	IMG_DO(PT_BEFORE_TRANSPARENT,     68, R16G16B16A16_SFLOAT, rgba16f, IMG_WIDTH,           IMG_HEIGHT     ) \
	IMG_DO(PT_RAYLENGTH_DIFFUSE,      69, R16G16B16A16_SFLOAT, rgba16f, IMG_WIDTH,           IMG_HEIGHT     ) \
	IMG_DO(PT_RAYLENGTH_SPECULAR,     70, R16G16B16A16_SFLOAT, rgba16f, IMG_WIDTH,           IMG_HEIGHT     ) \
	IMG_DO(PT_REFLECTED_ALBEDO,       71, R16G16B16A16_SFLOAT, rgba16f, IMG_WIDTH,           IMG_HEIGHT     ) \
	IMG_DO(PT_COMPOSITE_TRANSPARENT,  72, R16G16B16A16_SFLOAT, rgba16f, IMG_WIDTH,           IMG_HEIGHT     ) \
	IMG_DO(PT_RAY_LENGTH,             73, R32G32_SFLOAT,       rg32f,   IMG_WIDTH,           IMG_HEIGHT     ) \
	IMG_DO(PT_VIEW_DEPTH_SPLIT,       74, R32G32B32A32_SFLOAT, rgba32f, IMG_WIDTH,           IMG_HEIGHT     ) \
...
#define LIST_IMAGES_A_B \
	...
	IMG_DO(PT_RESTIR_DI_ID_A,         NUM_IMAGES_BASE + 30, R32_UINT,            r32ui,   IMG_WIDTH_MGPU,      IMG_HEIGHT     ) \
	IMG_DO(PT_RESTIR_DI_ID_B,         NUM_IMAGES_BASE + 31, R32_UINT,            r32ui,   IMG_WIDTH_MGPU,      IMG_HEIGHT     ) \
	IMG_DO(PT_RESTIR_DI_RES_A,        NUM_IMAGES_BASE + 32, R32G32_UINT,         rg32ui,  IMG_WIDTH_MGPU,      IMG_HEIGHT     ) \
	IMG_DO(PT_RESTIR_DI_RES_B,        NUM_IMAGES_BASE + 33, R32G32_UINT,         rg32ui,  IMG_WIDTH_MGPU,      IMG_HEIGHT     ) \
	...
	IMG_DO(PT_RESTIR_GI_NORM_RAD_A,   NUM_IMAGES_BASE + 36, R32G32B32A32_UINT,   rgba32ui,IMG_WIDTH_MGPU,      IMG_HEIGHT     ) \
	IMG_DO(PT_RESTIR_GI_NORM_RAD_B,   NUM_IMAGES_BASE + 37, R32G32B32A32_UINT,   rgba32ui,IMG_WIDTH_MGPU,      IMG_HEIGHT     ) \
	IMG_DO(PT_RESTIR_GI_WEIGHT_A,     NUM_IMAGES_BASE + 38, R32G32_UINT,         rg32ui,  IMG_WIDTH_MGPU,      IMG_HEIGHT     ) \
	IMG_DO(PT_RESTIR_GI_WEIGHT_B,     NUM_IMAGES_BASE + 39, R32G32_UINT,         rg32ui,  IMG_WIDTH_MGPU,      IMG_HEIGHT     ) \
...
#define LIST_IMAGES_B_A \
	...
	IMG_DO(PT_RESTIR_DI_ID_B,         NUM_IMAGES_BASE + 30, R32_UINT,            r32ui,   IMG_WIDTH_MGPU,      IMG_HEIGHT     ) \
	IMG_DO(PT_RESTIR_DI_ID_A,         NUM_IMAGES_BASE + 31, R32_UINT,            r32ui,   IMG_WIDTH_MGPU,      IMG_HEIGHT     ) \
	IMG_DO(PT_RESTIR_DI_RES_B,        NUM_IMAGES_BASE + 32, R32G32_UINT,         rg32ui,  IMG_WIDTH_MGPU,      IMG_HEIGHT     ) \
	IMG_DO(PT_RESTIR_DI_RES_A,        NUM_IMAGES_BASE + 33, R32G32_UINT,         rg32ui,  IMG_WIDTH_MGPU,      IMG_HEIGHT     ) \
	...
	IMG_DO(PT_RESTIR_GI_NORM_RAD_B,   NUM_IMAGES_BASE + 36, R32G32B32A32_UINT,   rgba32ui,IMG_WIDTH_MGPU,      IMG_HEIGHT     ) \
	IMG_DO(PT_RESTIR_GI_NORM_RAD_A,   NUM_IMAGES_BASE + 37, R32G32B32A32_UINT,   rgba32ui,IMG_WIDTH_MGPU,      IMG_HEIGHT     ) \
	IMG_DO(PT_RESTIR_GI_WEIGHT_B,     NUM_IMAGES_BASE + 38, R32G32_UINT,         rg32ui,  IMG_WIDTH_MGPU,      IMG_HEIGHT     ) \
	IMG_DO(PT_RESTIR_GI_WEIGHT_A,     NUM_IMAGES_BASE + 39, R32G32_UINT,         rg32ui,  IMG_WIDTH_MGPU,      IMG_HEIGHT     ) \
