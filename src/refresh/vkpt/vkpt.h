...
#define LIST_SHADER_MODULES \
	...
	SHADER_MODULE_DO(QVK_MOD_RESTIR_GI_TEMPORAL_COMP)                \
	SHADER_MODULE_DO(QVK_MOD_RESTIR_GI_SPATIAL_COMP)                 \
	SHADER_MODULE_DO(QVK_MOD_RESTIR_GI_APPLY_COMP)                   \
...
VkResult vkpt_restir_gi_initialize(void);
VkResult vkpt_restir_gi_destroy(void);
VkResult vkpt_restir_gi_create_pipelines(void);
VkResult vkpt_restir_gi_destroy_pipelines(void);
VkResult vkpt_restir_gi_record_cmd_buffer(VkCommandBuffer cmd_buf);
